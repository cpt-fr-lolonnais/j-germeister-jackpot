  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        jaeger: {
          green: "hsl(var(--jaeger-green))",
          dark: "hsl(var(--jaeger-dark))",
          orange: "hsl(var(--jaeger-orange))",
          "orange-glow": "hsl(var(--jaeger-orange-glow))",
          neon: "hsl(var(--jaeger-neon))",
          gold: "hsl(var(--jaeger-gold))",
        },
        sidebar: {
