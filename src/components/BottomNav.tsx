...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-border bg-card/95 backdrop-blur-sm pb-2">
      <div className="flex h-20 items-center justify-around max-w-md mx-auto">
        {tabs.map(tab => {
